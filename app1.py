...
def create_app():
    ...
    SHOP_PRODUCTS = [
    {
        ...
        "name": "iPhone 13 Pro",
        "price": "699 CHF",
        "description": "iPhone reconditionné premium avec batterie testée.",
    ...
    },
    {
        ...
        "price": "549 CHF",
        "description": "Smartphone Android performant et garanti.",
...
def boutique():
    ...
    if request.method == "POST":
        ...
        flash("Votre commande a été envoyée.", "success")
